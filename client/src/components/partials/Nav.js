...
export function Navigation() {
    ...
    // }
    return (
        <Navbar style={{ paddingTop:"3%",marginBottom: "5%",marginLeft:"-1%"}} variant="light" expand="lg" className="bg-body-tertiary">
            <Container >
                <Navbar.Brand href="/" >
                ...
                <Navbar.Collapse id="basic-navbar-nav" style={{justifyContent:"space-between"}}>
                    ...
                    <Nav id="links">
                        ...
                        <VscCircleFilled style={{ alignSelf: "center", color: "orange",marginLeft:"2%",marginRight:"2%",fontSize:"18px",marginTop:"-2px", width:"100%", maxWidth:"fit-content", minWidth:"fit-content" }} />
                    ...
                    {!token 
                        ?<Nav id="secondary-links">
                            ...
                            <span style={{ alignSelf: "center", margin:"2.5%", color: "orange",fontSize:"15px",fontFamily: "'Roboto', sans-serif"}}>or</span> 
                            <Nav.Link href="/register"><Button id="greenButton" style={{fontSize:"15px",height: "106%"}}>CREATE ACCOUNT</Button></Nav.Link>
                        </Nav>
                        
                        :<Nav id="secondary-links" style={{textDecoration: "underline",textUnderlineOffset:"18%",textDecorationThickness:"2px",fontSize:"16px",marginRight:"-1.5%"}}>
